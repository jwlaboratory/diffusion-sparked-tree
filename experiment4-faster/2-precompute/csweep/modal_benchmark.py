...
CACHE_DIR = "/results/csweep/cache"
...
# csweep/ -> 2-precompute/ -> experiment4-faster/ -> repo root; harness lives at root.
...
app = modal.App("ddtree-exp4-csweep")
...
def run_experiment(cfg: dict) -> dict:
    ...
    out = Path("/results/csweep/summary.json")
...
def main(smoke: bool = False, spawn: bool = False):
    ...
    if spawn:
        ...
        print("progress:  modal volume ls ddtree-results csweep/cache")
        print("fetch:     modal volume get ddtree-results csweep/summary.json")
        return
