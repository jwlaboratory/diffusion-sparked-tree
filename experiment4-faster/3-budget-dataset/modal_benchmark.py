...
METHODS = (
    # No exact-ref baseline in this grid: it is ~13-30 TPS and would dominate the
    # runtime across 5 budgets x 6 datasets. Its baseline is already known from the
    # C-sweeps. We only want the best-TPS builder here (output is identical at temp 0).
...
CACHE_DIR = "/results/dsbudget/cache"
...
# dsbudget/ -> 2-precompute/ -> experiment4-faster/ -> repo root; harness lives at root.
...
app = modal.App("ddtree-exp4-dsbudget")
...
def run_experiment(cfg: dict) -> dict:
    ...
    out = Path("/results/dsbudget/summary.json")
