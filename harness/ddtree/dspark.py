...
def dspark_generate(
    ...
    while start < max_length:
        ...
        if not is_cold:
            stage_times["draft_backbone"] += cuda_time() - backbone_stage_start
        ...
        if not is_cold:
            stage_times["draft_markov"] += cuda_time() - markov_stage_start
        ...
        if not is_cold:
            stage_times["draft_confidence"] += cuda_time() - confidence_stage_start
